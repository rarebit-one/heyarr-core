...
func TestLoadBearingFields(t *testing.T) {
	...
	tests := []struct {
		...
		{
			path: "Show Name Season 4 Mp4 1080p/Show Name S04E04.mp4", libraryType: Series,
			contentType: Series, workKey: "series:show name", title: "Show Name",
			sortTitle: "show name", editionKey: "season-04", editionLabel: "Season 04",
			assetRole: RolePrimary, rule: "series/sxxexx", work: map[string]any{},
			edition: map[string]any{"season": 4, "episode": 4},
		},
		{
			path: "Show Name (2018) Season 4 1080p WEB-DL/Show Name S04E01.mkv", libraryType: Series,
			contentType: Series, workKey: "series:show name:2018", title: "Show Name",
			sortTitle: "show name", year: 2018, editionKey: "season-04", editionLabel: "Season 04",
			assetRole: RolePrimary, rule: "series/sxxexx", work: map[string]any{},
			edition: map[string]any{"season": 4, "episode": 1},
		},
		{
			path: "Show.Name.S04.Complete.1080p.WEB/Show.Name.S04E02.1080p.WEB.mkv", libraryType: Series,
			contentType: Series, workKey: "series:show name", title: "Show Name",
			sortTitle: "show name", editionKey: "season-04", editionLabel: "Season 04",
			editionType: "web-dl", assetRole: RolePrimary, rule: "series/sxxexx", work: map[string]any{},
			edition: map[string]any{"season": 4, "episode": 2},
		},
		{
			path: "Show.Name.S04E03.1080p.WEB-DL/Show.Name.S04E03.1080p.WEB-DL.mkv", libraryType: Series,
			contentType: Series, workKey: "series:show name", title: "Show Name",
			sortTitle: "show name", editionKey: "season-04", editionLabel: "Season 04",
			editionType: "web-dl", assetRole: RolePrimary, rule: "series/sxxexx", work: map[string]any{},
			edition: map[string]any{"season": 4, "episode": 3},
		},
		{
			path: "Show Name Season 4 Complete/05 - Title.mkv", libraryType: Series,
			contentType: Series, workKey: "series:show name", title: "Show Name",
			sortTitle: "show name", editionKey: "season-04", editionLabel: "Season 04",
			assetRole: RolePrimary, rule: "series/season-dir", work: map[string]any{},
			edition: map[string]any{"season": 4, "episode": 5, "episode_title": "Title"},
		},
		{
			path: "Show Name Season 4 Mp4 1080p/poster.jpg", libraryType: Series,
			contentType: Series, workKey: "series:show name", title: "Show Name",
			sortTitle: "show name", editionKey: "season-04", editionLabel: "Season 04",
			assetRole: RoleArtwork, rule: "series/show", work: map[string]any{},
			edition: map[string]any{"season": 4},
		},
		{
			path: "TV/Show Name Season 4 Mp4 1080p/poster.jpg", libraryType: Series,
			contentType: Series, workKey: "series:show name", title: "Show Name",
			sortTitle: "show name", editionKey: "season-04", editionLabel: "Season 04",
			assetRole: RoleArtwork, rule: "series/show", work: map[string]any{},
			edition: map[string]any{"season": 4},
		...
		{
			path: "TV/Show Name (2018)/poster.jpg", libraryType: Series,
			contentType: Series, workKey: "series:show name:2018", title: "Show Name",
			sortTitle: "show name", year: 2018, editionKey: "default",
			assetRole: RoleArtwork, rule: "series/show", work: map[string]any{},
			edition: map[string]any{},
		},
		{
