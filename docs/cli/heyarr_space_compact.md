## heyarr space compact

Drop the changes the latest snapshot subsumes (§44)

### Synopsis

Compact the space's change log: drop the changes the latest snapshot subsumes
...
```
heyarr space compact <space-id> [flags]
```
