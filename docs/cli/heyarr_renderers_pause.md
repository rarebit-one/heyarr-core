## heyarr renderers pause

Hold position on a renderer

### Synopsis

Hold position. Use this when someone is coming back; `stop` releases the content.

```
heyarr renderers pause <renderer> [flags]
```
