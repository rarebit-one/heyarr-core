## heyarr space changes

List a space's stored changes AS THE PEER HOLDS THEM — ciphertext

### Synopsis

List the encrypted changes the controller stores for a space.
...
```
heyarr space changes <space-id> [flags]
```
